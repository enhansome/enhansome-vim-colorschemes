...
* [`mcchrish/vim-no-color-collections`](https://github.com/mcchrish/vim-no-color-collections) ⭐ 1,068 | 🐛 1 | 📅 2026-01-25 - List of colorschemes with barely any colors
* [`rainglow/vim`](https://github.com/rainglow/vim) ⭐ 492 | 🐛 3 | 🌐 Vim script | 📅 2018-10-24 - 320+ color themes for VIM
* [`chriskempson/base16-vim`](https://github.com/chriskempson/base16-vim) ⭐ 172 | 🐛 53 | 🌐 Vim Script | 📅 2024-06-08 - Syntax highlighting for hackers
